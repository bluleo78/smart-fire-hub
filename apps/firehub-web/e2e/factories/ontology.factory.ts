...
export function createOntologyGraph(overrides?: Partial<GraphData>): GraphData {
  ...
  // ontologyId: incident1을 제외한 모두 id=1(기본 스펙의 유일한 active 온톨로지)에 적재된 것으로
  // 취급한다. incident2는 schemaVersion과 마찬가지로 스탬프 도입 이전 레거시 노드라 ontologyId도 null.
  const nodes: GraphNode[] = [
    { key: ONTOLOGY_GRAPH_NODE_KEYS.incident1, type: 'Incident', name: '강남구 오피스텔 화재(2026-03-02)', sourceChunkCount: 5, schemaVersion: 1, ontologyId: 1 },
    { key: ONTOLOGY_GRAPH_NODE_KEYS.incident2, type: 'Incident', name: '송파구 아파트 화재(2026-04-11)', sourceChunkCount: 3, schemaVersion: null, ontologyId: null },
    { key: ONTOLOGY_GRAPH_NODE_KEYS.building, type: 'Building', name: '강남타워', sourceChunkCount: 4, schemaVersion: 1, ontologyId: 1 },
    { key: ONTOLOGY_GRAPH_NODE_KEYS.cause, type: 'Cause', name: '전기적 요인(누전)', sourceChunkCount: 2, schemaVersion: 1, ontologyId: 1 },
    { key: ONTOLOGY_GRAPH_NODE_KEYS.damage, type: 'Damage', name: '재산피해 약 3200만원', sourceChunkCount: 2, schemaVersion: 1, ontologyId: 1 },
    { key: ONTOLOGY_GRAPH_NODE_KEYS.equipment, type: 'Equipment', name: '스프링클러설비', sourceChunkCount: 3, schemaVersion: 1, ontologyId: 1 },
    { key: ONTOLOGY_GRAPH_NODE_KEYS.regulation, type: 'Regulation', name: '소방시설법 제9조', sourceChunkCount: 1, schemaVersion: 1, ontologyId: 1 },
  ];
  const edges = [
