 ...
 *
 * <b>변경된 키만 보내는 이유</b>: `PUT /api/platform/settings` 는 부분 갱신 계약이다. 미편집 키까지
 * 보내면 바뀌지 않은 키의 `updatedAt` 까지 새로 찍혀 "마지막 변경" 이 실제 변경을 가리키지 못하고,
 * 확인 다이얼로그가 보여 준 목록과 실제로 쓴 키가 어긋난다.
 *
