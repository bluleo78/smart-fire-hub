...
public class ColumnMappingService {
  ...
  public List<ColumnMappingDto> suggestMappings(
      List<String> fileHeaders, List<DatasetColumnResponse> datasetColumns) {
  ...
  private ColumnMappingDto findBestMatch(
      String fileHeader, List<DatasetColumnResponse> datasetColumns, Set<String> usedColumns) {
    ...
    for (DatasetColumnResponse col : datasetColumns) {
      if (!usedColumns.contains(col.columnName())
          && col.columnName().equalsIgnoreCase(fileHeader)) {
