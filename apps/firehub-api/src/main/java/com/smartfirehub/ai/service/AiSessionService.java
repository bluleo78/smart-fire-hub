...
public class AiSessionService {
    ...
    public Optional<AiSessionResponse> getSessionByContext(Long userId, String contextType, Long contextResourceId) {
    ...
    public void updateSessionTitle(Long userId, Long sessionId, String title) {
        AiSessionResponse session = aiSessionRepository.findById(sessionId)
    ...
    public void verifySessionOwnership(Long userId, String sessionId) {
        aiSessionRepository.findByUserIdAndSessionId(userId, sessionId)
                .orElseThrow(() -> new AccessDeniedException("AI 세션에 대한 권한이 없습니다: " + sessionId));
    }
