...
public class SettingsRepository {
    ...
    private static final Field<String> DESCRIPTION = field(name("system_settings", "description"), String.class);
    private static final Field<LocalDateTime> UPDATED_AT = field(name("system_settings", "updated_at"), LocalDateTime.class);
    private static final Field<Long> UPDATED_BY = field(name("system_settings", "updated_by"), Long.class);
