...
public class AuditLogRepository {
    ...
    private static final Field<String> AL_USERNAME = field(name("audit_log", "username"), String.class);
    ...
    private static final Field<String> AL_DESCRIPTION = field(name("audit_log", "description"), String.class);
    private static final Field<LocalDateTime> AL_ACTION_TIME = field(name("audit_log", "action_time"), LocalDateTime.class);
    private static final Field<String> AL_IP_ADDRESS = field(name("audit_log", "ip_address"), String.class);
    private static final Field<String> AL_USER_AGENT = field(name("audit_log", "user_agent"), String.class);
    private static final Field<String> AL_RESULT = field(name("audit_log", "result"), String.class);
    private static final Field<String> AL_ERROR_MESSAGE = field(name("audit_log", "error_message"), String.class);
    ...
    public Long save(Long userId, String username, String actionType,
                     String resource, String resourceId, String description,
                     String ipAddress, String userAgent,
                     String result, String errorMessage, JSONB metadata) {
    ...
    public Optional<AuditLogResponse> findById(Long id) {
        return dsl.select(AL_ID, AL_USER_ID, AL_USERNAME, AL_ACTION_TYPE, AL_RESOURCE,
    ...
    public List<AuditLogResponse> findByResource(String actionType, String resource, String resourceId) {
