...
public final class UrlUtils {
  ...
  /**
   * baseUrl과 path를 결합한다. - baseUrl 끝 슬래시 제거, path 앞 슬래시 보장 - path가 null/blank/"/"(루트 단독)이면 baseUrl만
   * 반환.
   *
   * <p>"/" 단독은 의미가 없는데 그대로 결합하면 baseUrl 이 이미 endpoint 인 경우(예: .../getWthrDataList/) trailing slash
   * 로 인해 외부 서버가 404 를 반환할 수 있다. (#114)
   */
