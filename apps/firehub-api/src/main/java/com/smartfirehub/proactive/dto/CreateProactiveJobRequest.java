 ...
 * ProactiveJobService.validateCronAndTimezone})에서 Spring {@code CronExpression.parse} 와 {@code ZoneId.of} 로
 * 사전 검증한다. 잘못된 값은 400으로 반환되어 스케줄러 silent fail 을 막는다 (#221).
 */
