...
public class StSquaregrid extends TableImpl<StSquaregridRecord> {
     ...
     */
    @Deprecated
    public final TableField<StSquaregridRecord, Object> GEOM = createField(DSL.name("geom"), DefaultDataType.getDefaultDataType("\"public\".\"geometry\""), this, "");
    ...
    private StSquaregrid(Name alias, Table<StSquaregridRecord> aliased, Field<?>[] parameters, Condition where) {
