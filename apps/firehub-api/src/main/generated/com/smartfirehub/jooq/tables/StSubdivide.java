...
public class StSubdivide extends TableImpl<StSubdivideRecord> {
     ...
     */
    @Deprecated
    public final TableField<StSubdivideRecord, Object> ST_SUBDIVIDE_ = createField(DSL.name("st_subdivide"), DefaultDataType.getDefaultDataType("\"geometry\""), this, "");
    ...
    private StSubdivide(Name alias, Table<StSubdivideRecord> aliased, Field<?>[] parameters, Condition where) {
