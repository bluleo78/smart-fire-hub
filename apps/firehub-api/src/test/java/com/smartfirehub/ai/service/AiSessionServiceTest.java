...
class AiSessionServiceTest extends IntegrationTestBase {
  ...
  void createSession_success() {
    ...
    AiSessionResponse result =
        aiSessionService.createSession(
            userId, new CreateAiSessionRequest("session-abc", "dataset", 42L, "Dataset Chat"));
  ...
  void verifySessionOwnership_ownSession_noException() {
    ...
    aiSessionService.createSession(
        userId, new CreateAiSessionRequest("session-own", null, null, "My Session"));
  ...
  void updateSessionTitle_ownSession_success() {
    ...
    AiSessionResponse created =
        aiSessionService.createSession(
            userId, new CreateAiSessionRequest("session-upd", null, null, "Original Title"));
  ...
  void updateSessionTitle_otherUser_throwsAccessDenied() {
    ...
    assertThatThrownBy(
            () -> aiSessionService.updateSessionTitle(user2.id(), created.id(), "Stolen Title"))
        .isInstanceOf(AccessDeniedException.class);
  }
  ...
  void deleteSession_ownSession_success() {
    ...
    AiSessionResponse created =
        aiSessionService.createSession(
            userId, new CreateAiSessionRequest("session-del", null, null, "To Delete"));
