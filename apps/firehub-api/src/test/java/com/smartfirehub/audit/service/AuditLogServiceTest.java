...
class AuditLogServiceTest extends IntegrationTestBase {
    ...
    void setUp() {
        ...
        auditLogService.log(adminId, "admin", "CREATE", "dataset", "1",
                "데이터셋 생성", "127.0.0.1", "Mozilla/5.0", "SUCCESS", null, null);
        auditLogService.log(adminId, "admin", "UPDATE", "dataset", "1",
                "데이터셋 수정", "127.0.0.1", "Mozilla/5.0", "SUCCESS", null, null);
        auditLogService.log(userId, "user1", "LOGIN", "user", null,
                "로그인 성공", "192.168.1.1", "Chrome", "SUCCESS", null, null);
        auditLogService.log(userId, "user1", "IMPORT", "dataset", "2",
                "CSV 임포트 실패", "192.168.1.1", "Chrome", "FAILURE", "파일 형식 오류",
                Map.of("filename", "data.csv"));
    }

    @Test
    void getAuditLogs_noFilter_returnsAll() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs(null, null, null, null, 0, 20);
    ...
    void getAuditLogs_searchByUsername_filtersResults() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs("user1", null, null, null, 0, 20);
    ...
    void getAuditLogs_searchByDescription_filtersResults() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs("임포트", null, null, null, 0, 20);
    ...
    void getAuditLogs_filterByActionType_filtersResults() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs(null, "CREATE", null, null, 0, 20);
    ...
    void getAuditLogs_filterByResource_filtersResults() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs(null, null, "user", null, 0, 20);
    ...
    void getAuditLogs_filterByResult_filtersResults() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs(null, null, null, "FAILURE", 0, 20);
    ...
    void getAuditLogs_combinedFilters_filtersResults() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs(null, "CREATE", "dataset", "SUCCESS", 0, 20);
    ...
    void getAuditLogs_pagination_works() {
        PageResponse<AuditLogResponse> page0 = auditLogService.getAuditLogs(null, null, null, null, 0, 2);
        ...
        PageResponse<AuditLogResponse> page1 = auditLogService.getAuditLogs(null, null, null, null, 1, 2);
    ...
    void getAuditLogs_withMetadata_returnsJsonString() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs(null, "IMPORT", null, null, 0, 20);
    ...
    void getAuditLogs_noMatch_returnsEmpty() {
        PageResponse<AuditLogResponse> result = auditLogService.getAuditLogs("nonexistent", null, null, null, 0, 20);
