...
class ApiConnectionRepositoryTest extends IntegrationTestBase {
  ...
  void findHealthCheckable_returnsOnlyRecordsWithHealthCheckPath() {
    ...
    Long id1 =
        repository.save(
            "With HC 1", null, "API_KEY", "enc1", testUserId, "https://a.example.com", "/health");
    Long id2 =
        repository.save(
            "With HC 2", null, "BEARER", "enc2", testUserId, "https://b.example.com", "/ping");
    // healthCheckPath 없는 레코드 1개
    Long id3 =
        repository.save(
            "No HC", null, "API_KEY", "enc3", testUserId, "https://c.example.com", null);
