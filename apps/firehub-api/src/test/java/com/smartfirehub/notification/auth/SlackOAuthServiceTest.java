...
class SlackOAuthServiceTest {
  ...
  void isConfigured_returnsTrue_whenClientIdIsSet() {
    ...
    assertThat(slackOAuthService.isConfigured()).isTrue();
  }
  ...
  void isConfigured_returnsFalse_whenClientIdIsBlank() {
    ...
    ReflectionTestUtils.setField(slackOAuthService, "clientId", "");

    assertThat(slackOAuthService.isConfigured()).isFalse();
  }
  ...
  void isConfigured_returnsFalse_whenClientIdIsNull() {
    ...
    ReflectionTestUtils.setField(slackOAuthService, "clientId", null);
