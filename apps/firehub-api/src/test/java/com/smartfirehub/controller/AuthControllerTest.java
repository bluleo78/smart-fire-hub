package com.smartfirehub.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.smartfirehub.config.JwtProperties;
import com.smartfirehub.config.JwtTokenProvider;
import com.smartfirehub.config.SecurityConfig;
import com.smartfirehub.config.JwtAuthenticationFilter;
import com.smartfirehub.dto.*;
import com.smartfirehub.service.AuthService;
...
class AuthControllerTest {
    ...
    void signup_returnsCreated() throws Exception {
        ...
        UserResponse response = new UserResponse(1L, "test@example.com", "test@example.com", "Test User", LocalDateTime.now());
