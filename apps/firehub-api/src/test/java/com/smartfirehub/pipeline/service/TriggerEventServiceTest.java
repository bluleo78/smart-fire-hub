...
class TriggerEventServiceTest extends IntegrationTestBase {
    ...
    void setUp() {
        ...
        PipelineDetailResponse upstream = pipelineService.createPipeline(
                new CreatePipelineRequest("Upstream Pipeline", "Upstream", List.of()), testUserId);
        upstreamPipelineId = upstream.id();

        PipelineDetailResponse downstream = pipelineService.createPipeline(
    ...
    void chainTriggerLookup_withMatchingUpstream_findsTriggers() {
        ...
        triggerService.createTrigger(downstreamPipelineId, new CreateTriggerRequest(
                "Chain on Success",
        ...
        List<TriggerResponse> chainTriggers = triggerRepository.findEnabledChainTriggersByUpstreamId(upstreamPipelineId);
    ...
    void chainTriggerLookup_withNonMatchingUpstream_returnsEmpty() {
        ...
        List<TriggerResponse> chainTriggers = triggerRepository.findEnabledChainTriggersByUpstreamId(99999L);
    ...
    void onPipelineCompleted_withDisabledTrigger_doesNotFindIt() {
        ...
        TriggerResponse created = triggerService.createTrigger(downstreamPipelineId, new CreateTriggerRequest(
                "Disabled Chain",
                TriggerType.PIPELINE_CHAIN,
                "Disabled trigger",
                Map.of("upstreamPipelineId", upstreamPipelineId.intValue(), "condition", "SUCCESS")
