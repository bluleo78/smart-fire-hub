...
class ApiImportServiceTest extends IntegrationTestBase {
    ...
    void createApiImport_createsSuccessfully() {
        ...
        ApiImportRequest request = new ApiImportRequest(
                "My API Pipeline",
        ...
        // When
        ApiImportResponse response = apiImportService.createApiImport(testDatasetId, request, testUserId);
    ...
    void createApiImport_withSchedule_createsTrigger() {
        ...
        ApiImportRequest.ScheduleConfig schedule = new ApiImportRequest.ScheduleConfig(
                "0 6 * * *",
        ...
        Long triggerCount = dsl.selectCount()
